...
with st.sidebar:
    ...
    st.sidebar.markdown("""
    **BlockBook** adalah platform E-Library berbasis Web3 yang menghadirkan cara baru dalam mengakses dan mengelola literatur digital. Melalui NFT, membership berbasis blockchain, dan governance DAO, BlockBook memberikan pengalaman perpustakaan digital yang transparan, aman, dan inklusif bagi mahasiswa, dosen, peneliti, dan komunitas akademik.  
    
    ---
    #### 🔮 Vision Statement
    
    Membangun ekosistem perpustakaan digital terdesentralisasi yang memberdayakan komunitas pendidikan dengan akses terbuka, kepemilikan nyata atas literatur, dan kolaborasi demokratis melalui teknologi Web3.
    ...
    - ⭐ **Star / Fork**: [GitHub repo](https://github.com/mrbrightsides/blockbook)
...
# URL Ohara
iframe_url = "https://ohara.ai/mini-apps/062e5985-940b-4d8a-a051-ed79dd9e35d2"
